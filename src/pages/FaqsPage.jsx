  ...
  const faqData = [
    {
      ...
      content:
        "We do not charge a fee for our quote services to our customers.",
    },
    {
  ...
  return (
    <div className="d-flex-column">
      <div className="container-bg-color">
        <h1 className="font-family-2 display1">Frequently Asked Questions</h1>
      </div>
      <div className="faqs" id="faqs" key="faqs">
        <div className="faqs faqs-data">
          <Faqs items={faqData} />
        </div>
      </div>
    </div>
